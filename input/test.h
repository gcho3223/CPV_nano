...
// Mon Nov 18 22:15:01 2024 by ROOT version 6.32.06
// from TTree Events/Events
// found on file: /Users/seungkyu-ha/SK_Anlysis/Run2Full_v1/NanoAOD/Rootfiles_NanoAOD/Run2/2016_PreVFP/TTbarDilep/0EA7513F-75ED-704F-9D84-2AC4F31066FD.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[167];   //[nGenPart]
   Float_t         GenPart_mass[167];   //[nGenPart]
   Float_t         GenPart_phi[167];   //[nGenPart]
   Float_t         GenPart_pt[167];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[167];   //[nGenPart]
   Int_t           GenPart_pdgId[167];   //[nGenPart]
   Int_t           GenPart_status[167];   //[nGenPart]
   Int_t           GenPart_statusFlags[167];   //[nGenPart]
   UInt_t          nSubGenJetAK8;
   Float_t         SubGenJetAK8_eta[17];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_mass[17];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_phi[17];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_pt[17];   //[nSubGenJetAK8]
   ...
   Float_t         Jet_btagDeepCvB[29];   //[nJet]
   Float_t         Jet_btagDeepCvL[29];   //[nJet]
   Float_t         Jet_btagDeepFlavB[29];   //[nJet]
   Float_t         Jet_btagDeepFlavCvB[29];   //[nJet]
   Float_t         Jet_btagDeepFlavCvL[29];   //[nJet]
   Float_t         Jet_btagDeepFlavQG[29];   //[nJet]
   Float_t         Jet_chEmEF[29];   //[nJet]
   Float_t         Jet_chFPV0EF[29];   //[nJet]
   Float_t         Jet_chHEF[29];   //[nJet]
   Float_t         Jet_eta[29];   //[nJet]
   Float_t         Jet_hfsigmaEtaEta[29];   //[nJet]
   Float_t         Jet_hfsigmaPhiPhi[29];   //[nJet]
   ...
   UChar_t         Jet_nConstituents[29];   //[nJet]
   ...
   UChar_t         Muon_mvaLowPtId[13];   //[nMuon]
   UChar_t         Muon_pfIsoId[13];   //[nMuon]
   UChar_t         Muon_puppiIsoId[13];   //[nMuon]
   ...
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
   Float_t         TrigObj_pt[55];   //[nTrigObj]
   Float_t         TrigObj_eta[55];   //[nTrigObj]
   Float_t         TrigObj_phi[55];   //[nTrigObj]
   Float_t         TrigObj_l1pt[55];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[55];   //[nTrigObj]
   Float_t         TrigObj_l2pt[55];   //[nTrigObj]
   Int_t           TrigObj_id[55];   //[nTrigObj]
   Int_t           TrigObj_l1iso[55];   //[nTrigObj]
   Int_t           TrigObj_l1charge[55];   //[nTrigObj]
   Int_t           TrigObj_filterBits[55];   //[nTrigObj]
   Int_t           genTtbarId;
   UInt_t          nOtherPV;
   ...
   Float_t         GenVtx_t0;
   Int_t           Jet_genJetIdx[29];   //[nJet]
   Int_t           Jet_hadronFlavour[29];   //[nJet]
   Int_t           Jet_partonFlavour[29];   //[nJet]
   ...
   UChar_t         Muon_genPartFlav[13];   //[nMuon]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Users/seungkyu-ha/SK_Anlysis/Run2Full_v1/NanoAOD/Rootfiles_NanoAOD/Run2/2016_PreVFP/TTbarDilep/0EA7513F-75ED-704F-9D84-2AC4F31066FD.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/Users/seungkyu-ha/SK_Anlysis/Run2Full_v1/NanoAOD/Rootfiles_NanoAOD/Run2/2016_PreVFP/TTbarDilep/0EA7513F-75ED-704F-9D84-2AC4F31066FD.root");
      }
